...
switch (playerSide) do
{
    ...
    case west: 
	{
        // ...
        //Seize PlayerWeapons
        life_actions = life_actions + [player addAction["Search For Weapons",life_fnc_seizePlayerWeapon,cursorTarget,0,false,false,"",'!isNull cursorTarget && (player distance cursorTarget) < 6 && speed cursorTarget < 2 && cursorTarget isKindOf "Man" && (isPlayer cursorTarget) && (side cursorTarget == civilian) && (cursorTarget getVariable "restrained")']];
