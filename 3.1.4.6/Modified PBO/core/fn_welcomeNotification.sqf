...
[
	...
	"Check Out Www.Quantumnetwork.co, All Staff and Whitelist Applications will be handled there. All Cops must be in the teamspeak 3 server IP: Quantumnetwork.co",
	...
	"Quantum Network staff: Developer(s): -CDL-Wolf,QuantumCreature,Casey,And AceShadow   Admins: Quantum Creature, Casey, Diodenerd, AceShadow."
];
