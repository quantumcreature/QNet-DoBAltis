	...
	player createDiaryRecord ["serverrules",
		[
			"Communication Rules", 
				...
				1. Side Chat may not be used At Any Time For Voice Chat, Offenders Will Be Kicked/Banned.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				...
				5. Martial law may not be declared at any time Unless A CL States Otherwise.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				3. Refusal to pay a legit ticket 3 Times is grounds for arrest.<br/>
				...
				AAll Tickets Should be Equal To Their Bounty In The Wanted List.<br/><br/>
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				Left Shift+F: Cop Yelp (if cop)<br/>
				T: Vehicle Trunk<br/>
				...
				Left CTRL + H: Unholster's your pistol<br/>
				"
		]
	];